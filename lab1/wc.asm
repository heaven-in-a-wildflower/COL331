 ...
 195:	31 c0                	xor    %eax,%eax
{
 ...
 1b1:	5d                   	pop    %ebp
 1b2:	c3                   	ret
 1b3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 1ba:	00 
 1bb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
 ...
 4cc:	89 d1                	mov    %edx,%ecx
{
 ...
 561:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 568:	00 
...
printf(int fd, const char *fmt, ...)
{
 ...
 645:	5d                   	pop    %ebp
 646:	c3                   	ret
 647:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 64e:	00 
 64f:	90                   	nop
        printint(fd, *ap, 16, 0);
