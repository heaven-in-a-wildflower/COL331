...
main(int argc, char *argv[])
{
  ...
  27:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  2e:	00 
  2f:	90                   	nop
    ls(".");
    exit();
...
00000100 <ls>:
{
 ...
 129:	8d b5 d0 fd ff ff    	lea    -0x230(%ebp),%esi
 ...
 13d:	0f 88 bd 01 00 00    	js     300 <ls+0x200>
  switch(st.type){
 143:	0f b7 85 d0 fd ff ff 	movzwl -0x230(%ebp),%eax
 ...
 173:	8b 95 e0 fd ff ff    	mov    -0x220(%ebp),%edx
 179:	8b b5 d8 fd ff ff    	mov    -0x228(%ebp),%esi
 17f:	57                   	push   %edi
 ...
 203:	8d 85 c0 fd ff ff    	lea    -0x240(%ebp),%eax
 209:	6a 10                	push   $0x10
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 ...
 218:	0f 85 38 ff ff ff    	jne    156 <ls+0x56>
      if(de.inum == 0)
 21e:	66 83 bd c0 fd ff ff 	cmpw   $0x0,-0x240(%ebp)
 225:	00 
 226:	74 d8                	je     200 <ls+0x100>
      memmove(p, de.name, DIRSIZ);
 228:	83 ec 04             	sub    $0x4,%esp
 22b:	8d 85 c2 fd ff ff    	lea    -0x23e(%ebp),%eax
 231:	6a 0e                	push   $0xe
 233:	50                   	push   %eax
 ...
 260:	8b 8d e0 fd ff ff    	mov    -0x220(%ebp),%ecx
 266:	8b 95 d8 fd ff ff    	mov    -0x228(%ebp),%edx
 26c:	57                   	push   %edi
 26d:	0f bf 85 d0 fd ff ff 	movswl -0x230(%ebp),%eax
 ...
 345:	31 c0                	xor    %eax,%eax
{
 ...
 361:	5d                   	pop    %ebp
 362:	c3                   	ret
 363:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 36a:	00 
