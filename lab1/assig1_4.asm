...
int main(int argc, char *argv[])
{
  ...
  13:	8d b5 e8 fd ff ff    	lea    -0x218(%ebp),%esi
{
  19:	53                   	push   %ebx
  1a:	51                   	push   %ecx
  1b:	81 ec 10 02 00 00    	sub    $0x210,%esp
  21:	8b 79 04             	mov    0x4(%ecx),%edi
    fd = open("ls", O_RDWR);
  24:	6a 02                	push   $0x2
  26:	68 b8 07 00 00       	push   $0x7b8
  2b:	e8 e3 02 00 00       	call   313 <open>
    read(fd, buf, sizeof(buf));
  30:	83 c4 0c             	add    $0xc,%esp
  33:	68 00 02 00 00       	push   $0x200
    fd = open("ls", O_RDWR);
  38:	89 c3                	mov    %eax,%ebx
    read(fd, buf, sizeof(buf));
  3a:	56                   	push   %esi
  3b:	50                   	push   %eax
  3c:	e8 aa 02 00 00       	call   2eb <read>
    write(fd, buf, sizeof(buf));
  41:	83 c4 0c             	add    $0xc,%esp
  44:	68 00 02 00 00       	push   $0x200
  49:	56                   	push   %esi
  4a:	53                   	push   %ebx
  4b:	e8 a3 02 00 00       	call   2f3 <write>
    exec("ls", argv);
  50:	58                   	pop    %eax
  51:	5a                   	pop    %edx
  52:	57                   	push   %edi
  53:	68 b8 07 00 00       	push   $0x7b8
  58:	e8 ae 02 00 00       	call   30b <exec>
    close(fd);
  5d:	89 1c 24             	mov    %ebx,(%esp)
  60:	e8 96 02 00 00       	call   2fb <close>
    exit();
  ...
  75:	31 c0                	xor    %eax,%eax
{
  ...
  91:	5d                   	pop    %ebp
  92:	c3                   	ret
  93:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  9a:	00 
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb bb 07 00 00       	mov    $0x7bb,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 625:	a1 7c 0a 00 00       	mov    0xa7c,%eax
{
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 709:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	a1 7c 0a 00 00       	mov    0xa7c,%eax
 ...
 764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 767:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 ...
 787:	0a 00 00 
    base.s.size = 0;
 78a:	bf 80 0a 00 00       	mov    $0xa80,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 80 0a 00 00 80 	movl   $0xa80,0xa80
 796:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79b:	c7 05 84 0a 00 00 00 	movl   $0x0,0xa84
 7a2:	00 00 00 
    if(p->s.size >= nunits){
