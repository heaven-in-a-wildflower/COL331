...
int main(void)
{
  ...
  while (getcmd(buf, sizeof(buf)) >= 0)
  {
    ...
    if (buf[0] == 'b' && buf[1] == 'l' && buf[2] == 'o' && buf[3] == 'c' && buf[4] == 'k')
    {
      ...
      // Convert the syscall number to integer
      int syscall_num = 0;
      ...
      // Block the system call using the system call
    ...
    if (buf[0] == 'u' && buf[1] == 'n' && buf[2] == 'b' && buf[3] == 'l' && buf[4] == 'o' && buf[5] == 'c' && buf[6] == 'k')
    {
      ...
      // Unblock the system call using the system call
    ...
    if (buf[0] == 'c' && buf[1] == 'h' && buf[2] == 'm' && buf[3] == 'o' && buf[4] == 'd' && buf[5] == ' ')
    {
      ...
      if (mode > 7 || mode < 0)
      {
        printf(2, "mode not valid\n");
      }
      else if (chmod(filename, mode) < 0)
      {
        printf(2, "chamod failure\n");
      }
      printf(2, "She was there\n");
      printf(2, "I was here\n");
